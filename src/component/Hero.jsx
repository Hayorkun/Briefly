  ...
  return (
    <section className="px-5">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center">
        ...
        <button className="border border-white/5 hover:border-white/20 py-2 px-4 flex items-center gap-2 text-sm bg-white/5 rounded-xl hover:bg-white/20 transition">
          <FcGoogle />
          Sign in with google
        </button>
      </div>
